                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a href="admin/usermanager"><span class="mini-sub-pro">Cá nhân</span></a></li>
                                <li><a href="admin/companymanager"><span class="mini-sub-pro">Công ty</span></a></li>
                            </ul>
                        </li>
                        <li class="active">
                            <a class="has-arrow" href="index.html">
                                
                                <span class="mini-click-non">Quản lý bài đăng</span>
                            </a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a href="admin/jobmanager"><span class="mini-sub-pro">JOB</span></a></li>
                                <li><a href="admin/normalmanager"><span class="mini-sub-pro">NORMAL</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a title="Landing Page" href="admin/skillmanager" aria-expanded="false">
                                <!-- <span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span>  -->
                                <span class="mini-click-non">Quản lý kỹ năng</span>
                            </a>
                        </li>
                        <!-- <li>
                        ...
                        <!-- <li>
                            <a class="has-arrow" href="all-students.html" aria-expanded="false"><span class="mini-click-non">Quản lý tài khoản</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="all-students.html"><span class="mini-sub-pro">Danh sách tài khoản</span></a></li>
                                <li><a title="Add Students" href="add-student.html"><span class="mini-sub-pro">Thêm tài khoản</span></a></li>
