...
<section class="cover-sec">
			...
			<img src="images/resources/{{$pro->background}}" alt="">  <!--background user-->
								...
								<div class="main-left-sidebar">
									<div class="user_profile">
										<div class="user-pro-img">
											<img src="images/resources/{{$pro->avatar}}" alt="">    <!--avatar user-->
								...
								<div class="main-ws-sec">
									<div class="user-tab-sec rewivew">
										...
										<div class="star-descp">
											<span>{{$pro->title}}</span>                 <!--Title user-->
									...
									<div class="product-feed-tab" id="info-dd">
										...
										<div class="user-profile-ov st2">
											<h3><a href="#" title="" class="exp-bx-open">KINH NGHIỆM </a><a href="#" title="" class="exp-bx-open"><i class="fa fa-pencil"></i></a> <a href="#" title="" class="exp-bx-open"><i class="fa fa-plus-square"></i></a></h3>
											@foreach($experiences as $exp)
											<h4>{{$exp->subject}} <a href="#" title=""><i class="fa fa-pencil"></i></a></h4>
											<p>{{$exp->detail}} </p>
											@endforeach
